    ...
    <AppGradient colors={["#c5f0ec", "#fafafa","#fafafa"]}>
      <SafeAreaView className="flex flex-1 mb-10">
        <View className="flex-1">
          ...
          {/***********************************************Appointment*****************************************/}
          <View
            className="bg-light-100 mt-6 px-5 py-8 flex-1"
            style={{
          ...
          >
            <Text className="font-semibold text-xl ">Upcoming Appointment</Text>
            ...
            <Text className="font-semibold text-xl ">Medicine by Category</Text>
            <ScrollView
              horizontal
